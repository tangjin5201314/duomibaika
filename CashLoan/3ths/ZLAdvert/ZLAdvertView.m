...
//        _adView.image = [UIImage imageNamed:@"LaunchImage_667h"];
        ...
        [_countBtn setTitle:[NSString stringWithFormat:@"%d秒跳过", showtime] forState:UIControlStateNormal];
...
- (void)setImageName:(NSString *)imageName {
    ...
    _adView.image = [UIImage imageNamed:_imageName] ?  : [self assetsLaunchImage];
}
...
- (void)countDown {
    ...
    _count --;
    [_countBtn setTitle:[NSString stringWithFormat:@"%d秒跳过",_count] forState:UIControlStateNormal];
    if (_count == 0) {
...
- (void)removeAdvertView {
    ...
    [UIView animateWithDuration:0.3f animations:^{
        ...
        [FYPopupManger sharedInstance].adReady = YES;
