...
//  WecashTaobaoSDK
//
//  Created by 李哲楷 on 16/3/4.
//  Copyright © 2016年 com.wecash. All rights reserved.
//

#import <UIKit/UIKit.h>


@class CSWEToastStyle;

/**
 LZKToast is an Objective-C category that adds LZKToast notifications to the UIView
 object class. It is intended to be simple, lightweight, and easy to use. Most
 LZKToast notifications can be triggered with a single line of code.
 
 The `makeLZKToast:` methods create a new view and then display it as LZKToast.
 
 The `showLZKToast:` methods display any view as LZKToast.
 
 */
@interface UIView (LZKToast)

extern const NSString * CSWEToastPositionTop;
extern const NSString * CSWEToastPositionCenter;
extern const NSString * CSWEToastPositionBottom;
...
/**
 `CSWEToastStyle` instances define the look and feel for toast views created via the
 `makeToast:` methods as well for toast views created directly with
 `toastViewForMessage:title:image:style:`.
 
 @warning `CSWEToastStyle` offers relatively simple styling options for the default
 toast view. If you require a toast view with more complex UI, it probably makes more
 sense to create your own custom UIView subclass and present it with the `showToast:`
 methods.
 */
@interface CSWEToastStyle : NSObject
...
/**
 Creates a new instance of `CSWEToastStyle` with all the default values set.
 */
- (instancetype)initWithDefaultStyle NS_DESIGNATED_INITIALIZER;

/**
 @warning Only the designated initializer should be used to create
 an instance of `CSWEToastStyle`.
 */
...
/**
 `CSWEToastManager` provides general configuration options for all toast
 notifications. Backed by a singleton instance.
 */
@interface CSWEToastManager : NSObject
...
/**
 ...
 with with a nil style. By default, this is set to `CSWEToastStyle`'s default
 style.
 
 @param sharedStyle
 */
+ (void)setSharedStyle:(CSWEToastStyle *)sharedStyle;

/**
 Gets the shared style from the singlton. By default, this is
 `CSWEToastStyle`'s default style.
 
 @return the shared style
 */
+ (CSWEToastStyle *)sharedStyle;
...
/**
 ...
 Default is `CSWEToastPositionBottom`.
...
/**
 Returns the default toast position. Default is `CSWEToastPositionBottom`.
